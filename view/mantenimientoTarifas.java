...
public class mantenimientoTarifas extends javax.swing.JFrame {
    ...
    private void getCurrentTarifas() {
        ...
        this.listaRamales.forEach(e -> {
            tarifa t = tarifaDy.getAllRamales(currentUsser, e);
            if (t != null) {
    ...
    private void initComponents() {
        ...
        centerTable.setBorder(javax.swing.BorderFactory.createTitledBorder("TABLA UNIDADES"));
        centerTable.setLayout(new java.awt.GridLayout(1, 0));
        ...
        if (tbRamales.getColumnModel().getColumnCount() > 0) {
            tbRamales.getColumnModel().getColumn(1).setMinWidth(30);
            tbRamales.getColumnModel().getColumn(1).setPreferredWidth(30);
            tbRamales.getColumnModel().getColumn(1).setMaxWidth(30);
        }
